		...
		<div class="row justify-content-center">
            <div class="col-md-6 border rounded shadow p-4 mt-4">
                ...
                <div class='row no-gutters form-group'>
                    <span class="border-bottom border-success ml-2"><h4>Edit Consigner</h4></span>
                </div>
                <div class='row no-gutters justify-content-center'>
                    <div class='col-sm-10'>
                        <form method="post" action="{{ route('consigners.update', $consigner->id) }}" autocomplete="off">
                            @csrf
                            @method('PATCH')
                            <div class="row form-group mt-4">    
                                <div class="col-sm-2 my-auto teal text-center"><i class="fa fa-user"></i></div>
                                <div class="col-sm-10"><input type="text" class="form-control" name="name" placeholder="Name" autocomplete="off" value="{{ $consigner->name}}" required></div>
                            </div>
                        
                            <div class="row form-group">
                                <div class="col-sm-2 my-auto teal text-center"><i class="fa fa-phone"></i></div>
                                <div class="col-sm-10"><input type="text" class="form-control" name="phone" autocomplete='off' pattern='0[0-9]{10}' placeholder="First digit must be zero" value="{{ $consigner->phone}}" required></div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-10"><input type="email" class="form-control" name="email" placeholder="Email" value="{{ $consigner->email}}"></div>
                            </div>
                            <div class="row form-group">
                                <div class="col-sm-2 my-auto teal text-center"><i class="fa fa-home"></i></div>
                                <div class="col-sm-10"><input type="text" class="form-control" name="address" placeholder="Address" value="{{ $consigner->address}}"></div>
                            </div>
