         ...
         <div class="col-md-4 mr-auto">
            <nav aria-label="breadcrumb">
               <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Consigners</li>
               </ol>
           </nav>
         </div>
      <div class="col-md-3 offset-col-5 text-center">
         <div class="row no-gutters">
            <div class="col text-center">
            	<a href="{{route('consigners.create')}}">
                  <div class="icon-xl text-success"><i class="fa fa-plus-circle"></i></div>
                  <div class="micro">New Consigner</div>
               </a>
            </div>
         </div>
      </div>
				...
				<table class="table table-striped">
					...
					<tbody>
						...
						<tr>
								...
								<form action="{{ route('consigners.destroy', $consigner->id)}}" method="post" onsubmit="return confirm('Are you sure?')" class="p-0 m-0">
									<td class='text-center'>
										<a href="{{ route('consigners.edit', $consigner->id)}}" class='btn btn-sm btn-link text-success'><i class="fas fa-pen"></i></a>
										@csrf
										@method('DELETE')
